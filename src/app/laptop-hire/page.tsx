  ...
  const segments = [
    {
      title: 'For Students',
      icon: GraduationCap,
      description: 'Good for students who need a fast laptop but do not want to buy one yet.',
      benefits: [
        'Cheap way to get a good laptop for a short time.',
        'Use it while your own laptop is being fixed.',
        'Get a fast laptop for your school work.'
      ]
    },
    {
      title: 'For Offices',
      icon: Briefcase,
      description: 'Help your business grow by renting laptops for your workers. It saves you money.',
      benefits: [
        'Give laptops to new staff quickly.',
    ...
    },
    {
      title: 'For Events',
      icon: Users,
      description: 'Make sure everyone at your meeting has a good laptop to use.',
      benefits: [
  ...
  const marketAdvantanges = [
    {
      ...
      icon: TrendingDown,
      text: 'Laptops get old quickly. When you rent, you do not lose money and you always have a good machine.'
    },
    {
      ...
      <section className="py-20">
        <div className="container mx-auto px-4">
          <div className="mb-16 text-center">
            ...
            <h3 className="text-3xl font-black uppercase tracking-tighter text-black sm:text-4xl">Reasons to Rent instead of Buy</h3>
          </div>
          
          <div className="grid gap-8 md:grid-cols-3">
            {marketAdvantanges.map((item, i) => (
              <div key={i} className="flex flex-col p-8 border border-zinc-100 bg-zinc-50/50 hover:bg-white transition-all group rounded-3xl">
                <div className="mb-6 h-12 w-12 flex items-center justify-center bg-white border border-zinc-100 rounded-full group-hover:bg-primary transition-colors">
