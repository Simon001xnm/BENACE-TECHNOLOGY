  ...
  return (
    <footer className="bg-[#003087] text-white">
      ...
      <button 
        ...
        className="w-full bg-[#0070ba] py-4 text-[10px] font-black uppercase tracking-[0.2em] hover:bg-[#005ea6] transition-colors flex items-center justify-center gap-2"
      >
      ...
      <div className="border-t border-white/10 py-10">
        <div className="container mx-auto px-4 flex flex-col md:flex-row items-center justify-between gap-8">
          ...
          <div className="flex gap-4">
            <Link href="#" className="h-8 w-8 flex items-center justify-center rounded-full border border-white/20 hover:border-white hover:text-white transition-all">
      ...
      <div className="bg-[#002566] py-10 border-t border-white/5">
        <div className="container mx-auto px-4 text-center space-y-6">
          <div className="flex flex-wrap justify-center gap-6 text-[8px] text-white/40 font-black uppercase tracking-[0.2em]">
          ...
          <div className="flex flex-col items-center gap-2">
            <p className="text-[9px] font-black text-white/30 uppercase tracking-[0.2em] flex items-center justify-center flex-wrap gap-1">
              &copy; {currentYear}. MADE IN KENYA BY <Coffee className="h-3 w-3 text-white/50 mx-0.5" /> 
              <Link 
